...
* Java
  ...
  * Collections
    ...
    *  [Отличие HashMap от IdentityHashMap](#отличие-hashmap-от-identityhashmap)
...
* DevOps
  * Docker
    ...
    * [Как общаются контейнеры между собой, через что](#Как-общаются-контейнеры-между-собой,-через-что)
