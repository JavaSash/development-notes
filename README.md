...
Ограничения этой концепции:
   ...
   * самоописательные сообщения - клиент-серверные сообщения должны содержать достаточно информации, чтообы описать, как оно должно быть обработано (тип содержимого - application/json, text/html)
